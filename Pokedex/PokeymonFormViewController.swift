...
class PokeymonFormViewController: UITableViewController {
    ...
    @objc private func saveTapped() {
        ...
        if let existingPokeymon = pokeymon {
            let updatedPokeymon = Pokeymon(
                id: existingPokeymon.id,
                name: name,
                type: type,
                attack: attack,
                defense: defense,
            ...
            dataManager.updatePokeymon(updatedPokeymon)
        } else {
            ...
            dataManager.addPokeymon(newPokeymon)
        }

        delegate?.didSavePokeymon()
        dismiss(animated: true)
    }
